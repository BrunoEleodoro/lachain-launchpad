  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        <form className="space-y-4 md:max-w-1/2" onSubmit={onSubmitTransaction}>
          ...
          <button className="ring-offset-background focus-visible:ring-ring bg-primary hover:bg-primary/90 inline-flex h-10 w-full items-center justify-center whitespace-nowrap rounded-md bg-gradient-to-r from-blue-500 to-pink-500 px-4 py-2 text-sm font-medium text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
            
            type="submit"
          >
            CREATE A COIN
          </button>
          <p className="text-white">Cost To Deploy: ~0.02 SOL</p>
